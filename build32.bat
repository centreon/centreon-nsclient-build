...
set VERSION_PLUGIN=%VERSION_PLUGIN:~0,8%a
...
cmd /C %PERL_INSTALL_DIR%\perl\site\bin\pp --lib=centreon-plugins\ -o scripts\win32\centreon\centreon_plugins.exe centreon-plugins\centreon_plugins.pl ^
--unicode ^
-X IO::Socket::INET6 ^
