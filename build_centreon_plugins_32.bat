...
--link=%PERL_INSTALL_DIR%\c\bin\libiconv-2_.dll ^
--link=%PERL_INSTALL_DIR%\c\bin\liblzma-5_.dll ^
--link=%PERL_INSTALL_DIR%\c\bin\zlib1_.dll ^
...
-M centreon::common::protocols::sql::mode::connectiontime ^
-M centreon::common::protocols::sql::mode::sql ^
-M centreon::common::protocols::sql::mode::sqlstring ^
...
-M database::oracle::plugin ^
-M database::oracle::sqlpluscmd ^
-M database::oracle::mode::asmdiskgroupusage ^
-M database::oracle::mode::connectedusers ^
-M database::oracle::mode::corruptedblocks ^
-M database::oracle::mode::dataguard ^
-M database::oracle::mode::datafilesstatus ^
-M database::oracle::mode::datacachehitratio ^
-M database::oracle::mode::dictionarycacheusage ^
-M database::oracle::mode::eventwaitsusage ^
-M database::oracle::mode::frausage ^
-M database::oracle::mode::invalidobject ^
-M database::oracle::mode::librarycacheusage ^
-M database::oracle::mode::listasmdiskgroups ^
-M database::oracle::mode::listtablespaces ^
-M database::oracle::mode::longqueries ^
-M database::oracle::mode::passwordexpiration ^
-M database::oracle::mode::processusage ^
-M database::oracle::mode::redologusage ^
-M database::oracle::mode::rmanbackupproblems ^
-M database::oracle::mode::rmanbackupage ^
-M database::oracle::mode::rmanonlinebackupage ^
-M database::oracle::mode::rollbacksegmentusage ^
-M database::oracle::mode::sessionusage ^
-M database::oracle::mode::tablespaceusage ^
-M database::oracle::mode::tnsping ^
